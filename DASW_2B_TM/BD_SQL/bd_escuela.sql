...
('Problemática del Mundo Actual'),('Cálculo Infinitesimal I'),('Sistemas Operativos'),
('POO'),('Desarrollo y Arquitectura de Software'),('Física I'),('Análisis y Diseño de Sistemas I'),
